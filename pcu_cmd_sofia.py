...
print('Processing....please note the farther the FROM and TO PACs are, the longer the process takes.The result will be stored in pac_name_extract.txt in the scripts folder')
...
if ret == 0:
    ...
    for infile in glob.glob( os.path.join(path, str(pac_name) + '*') ):
